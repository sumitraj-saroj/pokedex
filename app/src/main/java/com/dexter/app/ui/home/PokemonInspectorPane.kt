...
import com.dexter.app.ui.detail.EvolutionTreeSection
import com.dexter.app.ui.detail.Interactive3DTradingCard
import com.dexter.app.ui.detail.MovesAndAbilitiesSection
import androidx.compose.animation.ExperimentalSharedTransitionApi
import com.dexter.app.ui.detail.TypeMatchupSection
import com.dexter.app.ui.detail.VariantPreviewStrip
import com.dexter.app.ui.detail.components.TcgCardsSection
...
fun PokemonInspectorPane(
    ...
    onOpenFullScreen: ((Int) -> Unit)? = null,
    ...
    if (basePokemon == null) {
        Box(
            ...
            if (uiState.isLoading) {
                PulsingPokeballLoader(message = "Loading Inspector...")
            } else {
                Text(
                    text = "Select a Pokémon from the list to inspect",
                            ...
                            if (onOpenFullScreen != null) {
                                IconButton(
                                    onClick = {
                                        ...
                                        onOpenFullScreen(basePokemon.id)
                                    },
                                    modifier = Modifier.size(Dimens.MinTouchTarget)
                                ) {
                                    Icon(
